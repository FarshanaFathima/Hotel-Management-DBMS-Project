...
#$EID=$_POST['EID'];
$sql ="SELECT * FROM employees where MID=$MID ";
...
if($numrows > 0)
   {
	...
	echo "<br>";
	 ...
	 echo"<form method=\"POST\" action=\"m_removeemp1.php\"<h3>SELECT THE NAME OF CUSTOMER YOU WANT TO DELETE<br><select name=Caname ></h3>
            <?php echo $options;
				?>
